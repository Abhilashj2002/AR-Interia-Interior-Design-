...
let servicePackagesPrewarmed = false;
...
const triggerBookingDataSync = (reason = 'booking-mutation') => {
  if (bookingSyncTimer !== null) {
    window.clearTimeout(bookingSyncTimer);
  }
  bookingSyncTimer = window.setTimeout(() => {
    ...
    void syncDashboardsAndInvoices({ silent: true })
      ...
      .catch((error) => {
        console.warn(`Booking sync failed (${reason}):`, error);
      });
  }, BOOKING_SYNC_DEBOUNCE_MS);
};
  ...
  featuredProjects: [
    {
      ...
      completionYear: '2024',
      images: [
        { url: '/spidey/images/white-logo-spiderman.png', caption: 'Exterior View' },
        { url: '/spidey/images/swimmingpool11.jpg', caption: 'Living Room' },
        { url: '/spidey/images/pooja-room7.jpg', caption: 'Gourmet Kitchen' },
        { url: '/spidey/images/kids-bedroom9.jpg', caption: 'Master Bedroom' },
        { url: '/spidey/images/garden (1).jpg', caption: 'Infinity Pool' }
      ],
    ...
    },
    {
      ...
      completionYear: '2024',
      images: [
        { url: '/spidey/images/classroom.jpg', caption: 'Living Area' },
        { url: '/spidey/images/kids-bedroom5.jpg', caption: 'Master Bedroom' },
        { url: '/spidey/images/home theatre (1).jpg', caption: 'Modern Kitchen' },
        { url: '/spidey/images/gym (10).jpg', caption: 'Private Terrace' }
      ],
    ...
    },
    {
      ...
      completionYear: '2023',
      images: [
        { url: '/spidey/images/best-interior-websites-taylor-howes.webp', caption: 'Front Elevation' },
        { url: '/spidey/images/1.png', caption: 'Open Living' },
        { url: '/spidey/images/garden (1).jpg', caption: 'Kitchen' },
        { url: '/spidey/images/pooja-room7.jpg', caption: 'Garden' }
      ],
    ...
    },
    {
      ...
      completionYear: '2024',
      images: [
        { url: '/spidey/images/classroom.jpg', caption: 'Living Space' },
        { url: '/spidey/images/kids-bedroom9.jpg', caption: 'Bedroom' },
        { url: '/spidey/images/home theatre (1).jpg', caption: 'Kitchen' },
        { url: '/spidey/images/swimmingpool11.jpg', caption: 'Bathroom' }
      ],
    ...
    },
    {
      ...
      completionYear: '2023',
      images: [
        { url: '/spidey/images/white-logo-spiderman.png', caption: 'Villa Exterior' },
        { url: '/spidey/images/gym (10).jpg', caption: 'Grand Living' },
        { url: '/spidey/images/swimmingpool11.jpg', caption: 'Pool Area' },
        { url: '/spidey/images/home theatre (1).jpg', caption: 'Home Theater' }
      ],
    ...
    },
    {
      ...
      completionYear: '2023',
      images: [
        { url: '/spidey/images/classroom.jpg', caption: 'Living Room' },
        { url: '/spidey/images/kids-bedroom5.jpg', caption: 'Bedroom' },
        { url: '/spidey/images/pooja-room7.jpg', caption: 'Dining' },
        { url: '/spidey/images/garden (1).jpg', caption: 'Sea View Balcony' }
      ],
...
const CATEGORY_SAMPLE_CONCEPTS: Array<{
  ...
  { id: 'cat-kitchen-econ-1', category: 'kitchen', quality: 'economy', title: 'Essential Modular Kitchen', description: 'Budget-friendly modular kitchen setup with practical layout.', image: '/spidey/images/pooja-room7.jpg' },
  { id: 'cat-kitchen-prem-1', category: 'kitchen', quality: 'premium', title: 'Designer Kitchen Gallery', description: 'Premium kitchen with designer finishes and quality appliances.', image: '/spidey/images/home theatre (1).jpg' },
  { id: 'cat-kitchen-lux-1', category: 'kitchen', quality: 'luxury', title: 'Chef Gourmet Kitchen Suite', description: 'Luxury culinary space with premium materials and layout.', image: '/spidey/images/classroom.jpg' },
  { id: 'cat-living-econ-1', category: 'living room', quality: 'economy', title: 'Smart Living & Dining', description: 'Space-efficient living area with layered zoning.', image: '/spidey/images/white-logo-spiderman.png' },
  { id: 'cat-living-prem-1', category: 'living room', quality: 'premium', title: 'Designer Double Height Lounge', description: 'Premium lounge with dramatic ceiling and feature walls.', image: '/spidey/images/kids-bedroom5.jpg' },
  { id: 'cat-living-lux-1', category: 'living room', quality: 'luxury', title: 'Palatial Grand Living Atrium', description: 'Luxury atrium with statement chandeliers and marble finishes.', image: '/spidey/images/gym (10).jpg' },
  { id: 'cat-bath-econ-1', category: 'bathroom', quality: 'economy', title: 'Clean Vanity Bathroom', description: 'Durable bathroom with practical vanity and fixtures.', image: '/spidey/images/garden (1).jpg' },
  { id: 'cat-bath-prem-1', category: 'bathroom', quality: 'premium', title: 'Spa Luxury Bathroom', description: 'Premium bathroom with spa-inspired finishes and lighting.', image: '/spidey/images/pooja-room7.jpg' },
  { id: 'cat-bath-lux-1', category: 'bathroom', quality: 'luxury', title: 'Spa Sanctuary with Stone Textures', description: 'Luxury spa bathroom with stone, ambient mood and premium fixtures.', image: '/spidey/images/swimmingpool11.jpg' },
  { id: 'cat-bed-econ-1', category: 'bedroom', quality: 'economy', title: 'Comfort Family Suite', description: 'Warm bedroom concept with practical comfort furniture.', image: '/spidey/images/kids-bedroom9.jpg' },
  { id: 'cat-bed-prem-1', category: 'bedroom', quality: 'premium', title: 'Premium Master Retreat', description: 'Master suite with layered textures and mood lighting.', image: '/spidey/images/classroom.jpg' },
  { id: 'cat-bed-lux-1', category: 'bedroom', quality: 'luxury', title: 'Luxury Royal Master Suite', description: 'Palatial master bedroom with premium finishes and luxury amenities.', image: '/spidey/images/1.png' },
  { id: 'cat-dining-econ-1', category: 'dining room', quality: 'economy', title: 'Everyday Dining Nook', description: 'Simple practical dining area for family meals.', image: '/spidey/images/garden (1).jpg' },
  { id: 'cat-dining-prem-1', category: 'dining room', quality: 'premium', title: 'Elegant Dining Space', description: 'Premium dining room with designer furniture and lighting.', image: '/spidey/images/pooja-room7.jpg' },
  { id: 'cat-dining-lux-1', category: 'dining room', quality: 'luxury', title: 'Formal Dining Hall with Gallery', description: 'Luxury formal dining with statement chandelier and gallery walls.', image: '/spidey/images/swimmingpool11.jpg' },
  { id: 'cat-terrace-econ-1', category: 'terrace', quality: 'economy', title: 'Terrace Tea Lounge', description: 'Low-maintenance outdoor terrace lounge space.', image: '/spidey/images/gym (10).jpg' },
  { id: 'cat-terrace-prem-1', category: 'terrace', quality: 'premium', title: 'Landscape Terrace Deck', description: 'Premium terrace with integrated landscape and seating zones.', image: '/spidey/images/classroom.jpg' },
                ...
                <div class="p-4 rounded-xl border border-amber-100 bg-amber-50/40 shadow-sm">
                  <div class="flex justify-between items-start mb-3">
                    ...
                    <div class="text-right">
                      ...
                      <div class="text-xs font-semibold px-2 py-1 rounded-full inline-block mt-1 ${bookingStatusBadgeClass}">${escapeHtml(bookingStatusDisplay)}</div>
                      <div class="text-xs font-semibold px-2 py-1 rounded-full inline-block mt-1 ${paymentBadgeClass}">${bookingPaymentStatus === 'failed' ? 'âœ— Failed' : (bookingPaymentStatus === 'paid' ? 'âœ“ Paid' : 'â³ Pending')}</div>
                    </div>
                  </div>
                  <div class="flex gap-2 mt-4 pt-3 border-t border-amber-200">
                    ...
                    ` : ''}
                    ${bookingPaymentStatus !== 'paid' && !isApproved ? `
                      <div class="flex-1 py-2 rounded-lg bg-blue-50 text-blue-700 text-xs font-semibold text-center border border-blue-200">${bookingStatusDisplay === 'Rejected' ? 'ðŸš« Rejected by Admin' : 'â³ Awaiting Admin Approval'}</div>
                    ` : ''}
                    <button data-action="remove-booking" data-booking-id="${booking.id}" class="px-3 py-2 rounded-lg border border-red-200 text-red-600 text-xs font-semibold hover:bg-red-50 transition">Remove</button>
                  </div>
                </div>
        ...
        <form data-form="catalog-upload" class="p-6 space-y-5">
          ...
          <div class="pt-4">
            <button type="submit" class="w-full py-4 rounded-xl bg-[color:var(--primary)] text-white font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2" ${state.upload.isUploading ? 'disabled' : ''}>
              ${state.upload.isUploading ? '<span class="animate-spin">â³</span> Uploading...' : 'ðŸš€ Publish Design'}
            </button>
          </div>
        </form>
      </div>
...
const getAdminChartMetrics = (sourceBookings?: any[] | null) => {
  ...
  const designs = (state.customer?.designs && state.customer.designs.length > 0)
    ...
    : getDesigns();
  const categoryTitleMap = new Map(categories.map((category) => [String(category.id || ''), String(category.title || category.name || 'Unknown')]));
...
const initAdminChartsWhenVisible = () => {
  ...
  setTimeout(() => {
    ...
    console.log('initAdminChartsWhenVisible called, canvases found:', canvases.length);
    ...
    if (hasDetachedChartCanvas) {
      console.log('Has detached canvas, reinitializing');
      triggerAdminChartsInit();
      return;
    }
    ...
    if (!charts.revenue && !charts.profit && !charts.category && !charts.bookings) {
      console.log('No charts initialized yet, triggering init');
      triggerAdminChartsInit();
      return;
    }
...
// --- Auth action handlers (do not alter business logic) ----------------------
const handleLogin = async (formData: FormData) => {
  ...
  const finalizeLogin = (loginData: any, passwordValue: string) => {
    ...
    if (loginData.customer.role === 'admin') {
      ...
      upsertUserInState(state.currentUser);
    }
  ...
  if (state.loginForm.twoFactorChallengeId) {
    if (!verificationCode) {
      state.loginError = 'Enter the verification code sent to your email.';
      render();
      return;
    }
    ...
    try {
      render();
      const verifyResponse = await apiFetch('/auth/login/verify', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          challengeId: state.loginForm.twoFactorChallengeId,
      ...
      finalizeLogin(verifyData, password);
      return;
    } catch (error) {
      state.loginError = error instanceof Error ? error.message : 'Verification failed. Please try again.';
      render();
      return;
    }
  }
  ...
  if (state.loginForm.isSignup && password !== confirmPassword) {
  ...
  try {
    ...
    for (const candidate of backendLoginCandidates) {
      ...
      if (response.ok && loginData?.twoFactorRequired) {
        state.loginForm.twoFactorChallengeId = String(loginData.challengeId || '').trim();
        state.loginForm.twoFactorCode = String(loginData.debugCode || '').trim();
        state.loginForm.twoFactorMessage = String(loginData.message || 'Enter the verification code sent to your email.');
        state.loginForm.twoFactorDeliveryMethod = String(loginData.deliveryMethod || 'dev');
        state.loginForm.twoFactorDeliveredTo = String(loginData.deliveredTo || '');
        state.loginForm.twoFactorDebugCode = String(loginData.debugCode || '').trim();
        state.loginError = '';
        render();
        return;
      }
    ...
    finalizeLogin(loginData, password);
...
// --- Customer action handlers (do not alter business logic) ------------------
...
const syncDashboardsAndInvoices = async (options: { silent?: boolean } = {}) => {
  ...
  try {
    const syncTasks: Array<Promise<any>> = [refreshCustomerData({ silent })];
    if (state.currentUser?.role === 'admin') {
      syncTasks.push(refreshAdminData({ silent, force: true }));
    }
...
const handleCustomerBooking = async (designId: string) => {
  ...
  triggerBookingDataSync('design-booking-created');
...
const openFakeCardPayment = async (
  ...
  state.customer.paymentError = '';
  autoSyncPortfolioMetrics();
  triggerBookingDataSync('fake-payment-context-opened');
  render();
};
...
const updateDesignForm = (designId: string): boolean => {
  const normalizedId = String(designId || '').trim();
  const matchId = (item: any) => String(item?.id || '').trim() === normalizedId;
  const design = state.customer.designs.find(matchId)
    || state.catalog.find(matchId)
    || getDesigns().find(matchId);
...
const openAdminDesignEditor = (designId: string | null, modelId: string | null) => {
  ...
  const matchId = (item: any, id: string) => String(item?.id || '').trim() === id;
  if (designId) {
    design = state.customer.designs.find((item) => matchId(item, normalizedDesignId))
      || state.catalog.find((item) => matchId(item, normalizedDesignId))
      || getDesigns().find((item) => matchId(item, normalizedDesignId));
  } else if (modelId) {
    design = state.catalog.find((m) => matchId(m, normalizedModelId));
  }
  ...
  const formImages = (Array.isArray((design as any).images) && (design as any).images.length > 0)
    ? ((design as any).images as string[])
    : (design.previewImage ? [design.previewImage] : []);
  state.admin.designForm = {
    id: design.id,
    title: design.title,
...
const generateImageVariants = async (dataUrl: string, prompt: string, count = 6): Promise<(AIDesignVariant & { design3DIndex: number })[]> => {
  try {
    // Skip the AI API and directly use client-side generation
    // This avoids the "model does not support image input" error
    console.log('[AI Generate] Using client-side design generation');
    return generateImageVariantsClientSide(dataUrl, prompt, count);
  } catch (error) {
    console.error('[AI Generate] Error:', error);
    state.smartStudio.error = error instanceof Error ? error.message : 'Failed to generate designs. Please try selecting designs from our catalog.';
...
root.addEventListener('click', async (event) => {
  ...
  switch (action) {
    ...
    case 'add-calc-image-row': {
      console.log('Add calc image row clicked');
      try {
        const current = ((state.admin as any).calculatorImageLibrary || []).slice();
        current.unshift({
        ...
        state.admin.calculatorTab = 'settings';
        console.log('Image library now has', current.length, 'items');
        alert('Add Image clicked! Library now has ' + current.length + ' items');
        render();
      } catch (e) {
        console.error('Error adding image row:', e);
      }
      break;
    }
    ...
    case 'save-calc-section': {
      const section = button.getAttribute('data-section');
      if (!section || !state.admin.calculatorForm) return;
      
      if (section === 'core') {
        const baseSqftRate = Number((root.querySelector('[data-admin-calc="baseSqftRate"]') as HTMLInputElement)?.value || state.admin.calculatorForm.baseSqftRate);
        const updatedSettings: CalculatorSettings = {
          ...state.admin.calculatorForm,
          baseSqftRate
        };
        writeCalculatorSettings(updatedSettings);
        state.admin.calculatorForm = { ...updatedSettings };
        state.calculator.settings = { ...updatedSettings };
        state.confirmMessage = 'Core economics saved.';
        ...
        state.admin.calculatorForm = { ...updatedSettings };
        state.calculator.settings = { ...updatedSettings };
        state.confirmMessage = 'Category multipliers saved.';
        ...
        state.admin.calculatorForm = { ...updatedSettings };
        state.calculator.settings = { ...updatedSettings };
        state.confirmMessage = 'Shape multipliers saved.';
        ...
        state.admin.calculatorForm = { ...updatedSettings };
        state.calculator.settings = { ...updatedSettings };
        state.confirmMessage = 'Quality multipliers saved.';
      }
      render();
      break;
    }
    ...
    case 'toggle-menu':
      ...
      break;
    case 'ai-generate': {
      if (state.smartStudio.isGenerating) return;
      ...
      (async () => {
        try {
          ...
          console.log(`[Design Studio] Fetching from /api/categories/${encodeURIComponent(categoryName)}`);
          const response = await fetch(`/api/categories/${encodeURIComponent(categoryName)}`);
          
          if (!response.ok) {
            const errText = await response.text();
            console.error(`[Design Studio] API error: ${response.status} ${errText}`);
            throw new Error(`Failed to load designs (${response.status})`);
          }

          const categoryData = await response.json();
          const images = categoryData.images || [];
          console.log(`[Design Studio] Received ${images.length} images`);

          if (images.length === 0) {
            throw new Error(`No designs available for ${state.smartStudio.room}. Please try a different room type.`);
          }
          ...
          console.log(`[Design Studio] Generated ${variants.length} variants`);
        } catch (error) {
          const errorMsg = error instanceof Error ? error.message : 'Generation failed.';
          console.error('[Design Studio] Generate error:', errorMsg);
          
          if (/does not support image input/i.test(errorMsg.toLowerCase()) || /cannot read image/i.test(errorMsg.toLowerCase()) || /image\.png/i.test(errorMsg) || /model does not support/i.test(errorMsg.toLowerCase())) {
            state.smartStudio.error = 'This design model does not support image input. Please try using a text prompt instead, or select designs from our catalog.';
          } else {
            state.smartStudio.error = errorMsg;
          }
        } finally {
          state.smartStudio.isGenerating = false;
          render();
    ...
    case 'open-package-modal': {
      const pkgId = button.getAttribute('data-package-id');
      if (!pkgId) return;
      const pkg = getCustomerDisplayPackageById(pkgId);
      if (!pkg) return;
    ...
    case 'view-customer': {
      ...
      (state.admin as any).customerPaymentsCache = null;
      (state.admin as any).customerPaymentsLoading = true;
      render();
      // Fetch real payment history from backend DB
      (async () => {
        try {
          const resp = await apiFetch(`/payments/customer/${encodeURIComponent(customerId)}`, {
            headers: getAuthHeaders()
          });
          if (resp.ok) {
            const data = await resp.json();
          ...
          if (String((state.admin as any).viewingCustomerId || '') === String(customerId)) {
            render();
          }
        }
      })();
    ...
    case 'save-category': {
      ...
      (async () => {
        try {
          ...
          if (!resp.ok) throw new Error('Category update failed');
          state.confirmMessage = 'Category saved successfully.';
        } catch (error) {
          console.warn('Category save API failed, using local store:', error);
          updateCategory(id, category);
          state.confirmMessage = 'Category saved locally.';
        }
        await refreshCustomerData();
        render();
      })();
    ...
    case 'save-design': {
      ...
      (async () => {
        try {
          const resp = await apiFetch(`/designs/${encodeURIComponent(id)}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json', ...getAuthHeaders() },
            body: JSON.stringify(design)
          });
          if (!resp.ok) throw new Error('Design update failed');
          state.confirmMessage = 'Design saved successfully.';
        } catch (error) {
          console.warn('Design save API failed, using local store:', error);
          updateDesign(id, design);
          state.confirmMessage = 'Design saved locally.';
        }
        await refreshCustomerData();
        render();
      })();
    ...
    case 'admin-clear-package-cache': {
      if (state.currentUser?.role !== 'admin') return;
      customerDisplayPackagesCache = null;
      customerDisplayPackagesByIdCache = null;
    ...
    case 'admin-load-design-category': {
      ...
      const category = (state.customer.categories || []).find((cat: any) => cat.id === categoryId)
        || getCategories().find((cat: any) => cat.id === categoryId);
      const categoryName = category?.title || category?.name || categoryId;
      const localImages = Array.isArray(category?.images) ? category.images : [];
...
root.addEventListener('input', (event) => {
  ...
  // Generic handler for portfolioContent bindings
  if (bind.startsWith('portfolioContent.')) {
    const path = bind.substring('portfolioContent.'.length).split('.');
    let obj: any = state.portfolioContent;
...
root.addEventListener('change', async (event) => {
  ...
  if (target instanceof HTMLInputElement && target.type === 'file') {
    ...
    if (action === 'upload-calc-image') {
      const row = target.closest('[data-admin-calc-image-row]') as HTMLElement | null;
      if (!row) {
        alert('Error: Could not find image row');
        return;
      }
      const rowId = row.getAttribute('data-id');
      const imageLibrary = getAdminImageLibrary();
      const index = imageLibrary.findIndex((item: any) => String(item?.id || '') === String(rowId));
      const file = target.files?.[0];
      if (!file || index < 0) {
        alert('Error: Invalid file or image not found');
        render();
        return;
      }
      ...
      try {
        ...
        imageLibrary[index] = { ...imageLibrary[index], image: dataUrl };
        (state.admin as any).calculatorImageLibrary = imageLibrary;
...
root.addEventListener('submit', async (event) => {
  ...
  switch (formType) {
    ...
    case 'set-booking-summary-filter': {
      const selected = String(formData.get('value') || 'all');
      if (selected === 'paid' || selected === 'pending' || selected === 'failed') {
        state.admin.bookingFilter.paymentStatus = selected as AdminState['bookingFilter']['paymentStatus'];
        state.admin.bookingFilter.approvalStatus = 'all';
      } else if (selected === 'approved') {
    ...
    case 'load-more-bookings': {
      console.log('ðŸ“¥ Loading more bookings...');
      const pagination = (state.admin as any).bookingsPagination;
      if (!pagination || !pagination.hasMore) {
        console.log('No more bookings to load');
        break;
      }

      const nextOffset = (pagination.offset || 0) + (pagination.limit || 50);
      ...
      apiFetch(`/bookings?${bookingParams}`, { headers: authHeaders }, 5000)
        ...
        .then(data => {
          if (data.success && Array.isArray(data.bookings)) {
            ...
            const existingIds = new Set(state.admin.bookings.map((b: any) => b.id));
            const uniqueNewBookings = newBookings.filter((b: any) => !existingIds.has(b.id));
            ...
            console.log(`âœ… Loaded ${uniqueNewBookings.length} more bookings (${state.admin.bookings.length} total)`);
            renderStabilized();
          }
        })
        .catch(error => {
...
const init = async () => {
  ...
  try {
    ...
    console.log('Loading screen set, about to continue init');
    ...
    try {
      ...
      console.warn('loadState failed, proceeding with local data:', error);
    }
    console.log('After loadState, about to check chatbot messages');
    if (!state.chatbot.messages || state.chatbot.messages.length <= 1) {
      console.log('Calling resetChatbotMessages');
      resetChatbotMessages();
      console.log('resetChatbotMessages completed');
    }
    // Paint immediately from local data; background refreshes can patch in fresh data later.
    console.log('About to call render() - this should appear');
    try {
      render();
      console.log('Render completed successfully');
    } catch (error) {
      console.error('Render failed:', error);
      console.log('In catch block, about to update DOM');
      root.innerHTML = `<div style="padding: 20px; color: red;">Render failed: ${error.message}</div>`;
      console.log('DOM updated in catch block');
    }
