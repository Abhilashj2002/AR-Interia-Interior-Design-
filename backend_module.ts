// --- Payment status color mapping for admin bookings (global, permanent) ---
...
import { renderHomePageFeature } from './frontend/src/features/homepage/render';
import { renderGalleryFeature } from './frontend/src/features/gallery/render';
import { renderServicesFeature } from './frontend/src/features/services/render';
import { renderShowroomFeature } from './frontend/src/features/luxury-showroom/render';
import { renderContactFeature } from './frontend/src/features/contact/render';
import { renderPortfolioFeature } from './frontend/src/features/portfolio/render';
import { renderCategoriesFeature } from './frontend/src/features/categories/render';
import { renderDesignStudioFeature } from './frontend/src/features/design-studio/render';
import { renderPriceCalculatorFeature } from './frontend/src/features/price-calculator/render';
import { getCalculatorService } from './frontend/src/services/calculatorService';
import type { CalculatorDesign, CalculatorConfig, CalcImageQuality } from './frontend/src/features/price-calculator/types';
import { renderPackageFeature } from './frontend/src/features/packages/render';
import { renderVideoFeature } from './frontend/src/features/video/render';
import { renderServiceDetailsFeature, renderServiceShowcaseDetailsFeature } from './frontend/src/features/services-details/render';
...
const SERVICE_MANAGER_SAMPLES: ServiceItem[] = [
  ...
  },
  {
    ...
    video: '/videos/room_masterbedroom.mp4'
  },
  {
    id: 'svc-modular-kitchen',
    title: 'Modular Kitchen',
    icon: 'ðŸ‘¨â€ðŸ³',
    description: 'Custom modular kitchens with premium finishes and smart storage solutions.',
    video: ''
  },
  {
    id: 'svc-wardrobe',
    ...
    icon: 'ðŸšª',
    description: 'Bespoke wardrobe solutions with smart storage and organization systems.',
    video: ''
  },
  {
    id: 'svc-living-room',
    ...
    icon: 'ðŸ›‹ï¸',
    description: 'Complete living room transformation with premium furniture and dÃ©cor.',
    video: ''
  },
  {
    id: 'svc-bedroom',
    ...
    icon: 'ðŸ›ï¸',
    description: 'Cozy and elegant bedroom interiors with custom furniture.',
    video: ''
  },
  {
    id: 'svc-false-ceiling',
    title: 'False Ceiling',
    icon: 'âœ¨',
  ...
  },
  {
    ...
    icon: 'ðŸ–Œï¸',
    description: 'Professional painting, texture and wall finishing services.',
    video: ''
  },
  {
    id: 'svc-flooring',
    title: 'Flooring',
    icon: 'ðŸº',
    description: 'Premium flooring options - marble, wood, vinyl and more.',
    video: ''
  },
  {
    id: 'svc-lighting',
    ...
    icon: 'ðŸ’¡',
    description: 'Architectural lighting solutions for ambient and task lighting.',
    video: ''
  },
  {
    id: 'svc-bathroom',
    ...
    icon: 'ðŸš¿',
    description: 'Modern bathroom fixtures, tiling and complete renovation.',
    video: ''
  },
  {
    id: 'svc-space-planning',
    title: 'Space Planning',
    icon: 'ðŸ“',
    description: 'Optimal space utilization with professional layouts.',
    video: ''
  },
  {
    id: 'svc-color',
    ...
    icon: 'ðŸŽ¨',
    description: 'Professional color palette selection and consultation.',
    video: ''
  },
  {
    id: 'svc-furniture',
    ...
    icon: 'ðŸª‘',
    description: 'Curated furniture selection for your space.',
    video: ''
  },
  {
    id: 'svc-carpentry',
    ...
    icon: 'ðŸªš',
    description: 'Bespoke carpentry and joinery work for all interiors.',
    video: ''
  },
  {
    id: 'svc-material',
    ...
    icon: 'ðŸ§±',
    description: 'Expert guidance on materials selection and procurement.',
    video: ''
  },
  {
    id: 'svc-balcony',
    ...
    icon: 'ðŸŒ¿',
    description: 'Transform balconies into beautiful green spaces.',
    video: ''
  },
  {
    id: 'svc-pooja',
    title: 'Pooja Room',
    icon: 'ðŸ•‰ï¸',
    description: 'Sacred space design with traditional and modern aesthetics.',
    video: ''
  },
  {
    id: 'svc-kids',
  ...
  },
  {
    ...
    title: 'Home Office',
    icon: 'ðŸ’¼',
    description: 'Productive workspace solutions for remote work.',
    video: ''
  },
  {
    id: 'svc-dining',
    title: 'Dining Area',
    icon: 'ðŸ½ï¸',
    description: 'Elegant dining space designs with custom furniture.',
    video: ''
  },
  {
    id: 'svc-tvunit',
    ...
    icon: 'ðŸ“º',
    description: 'Modern TV unit and entertainment wall setup.',
    video: ''
  },
  {
    id: 'svc-crockery',
    title: 'Crockery Unit',
    icon: 'ðŸ¥£',
    description: 'Designer crockery display units and cabinets.',
    video: ''
  },
  {
    id: 'svc-study',
    title: 'Study Room',
    icon: 'ðŸ“š',
    description: 'Functional study room interiors with smart storage.',
    video: ''
  },
  {
    id: 'svc-guest',
    title: 'Guest Room',
    icon: 'ðŸ›Œ',
    description: 'Welcoming guest room designs with comfortable furniture.',
    video: ''
  },
  {
    id: 'svc-utility',
    title: 'Utility Area',
    icon: 'ðŸ§º',
    description: 'Smart laundry and utility space solutions.',
    video: ''
  },
  {
    id: 'svc-corridor',
  ...
  },
  {
    ...
    icon: 'ðŸŒ³',
    description: 'Outdoor terrace and garden setup with landscaping.',
    video: ''
  },
  {
    id: 'svc-commercial',
    ...
    icon: 'ðŸ¢',
    description: 'Office and commercial space design and execution.',
    video: ''
  }
];
...
const refreshCustomerData = async (options: RefreshOptions = {}) => {
  ...
  try {
    ...
    const requests = [
      ...
      apiFetch('/portfolio-content', {}, 8000).then((r) => r.json()).catch(() => null),
    ...
    if (bookingsUrl) {
      ...
      requests.push(
        fetchWithTimeout(bookingsUrl, headers ? { headers } : {}, 10000)
          .then((r) => r.json())
          .catch(() => null)
      );
    } else {
...
const getCategoryFamilyKey = (rawKey: string) => {
  ...
  if (key.includes('classroom') || key.includes('class') || key.includes('education')) return 'classroom';
...
const ensureDesignsForCategory = (categoryId: string) => {
  ...
  if (!selectedCategory) return;
   ...
   let images = Array.isArray(selectedCategory.images) ? selectedCategory.images : [];
   // Fallback: If no images, try to fetch from loadedCategory or show debug log
   if (images.length === 0 && state.admin.loadedCategory && state.admin.loadedCategory.id === categoryId) {
     const rawLoadedImages = Array.isArray(state.admin.loadedCategory.images) ? state.admin.loadedCategory.images : [];
     images = rawLoadedImages.map(img => ({
       name: String(img?.name || selectedCategory.title || selectedCategory.name || 'Design').trim(),
...
const resolvePlayableVideoUrl = (url: string) => {
  ...
  // Defensive check: Skip known malformed placeholder URLs (e.g., ISO dates with colons replaced by dashes)
  // which often point to non-existent dynamic assets in the uploads folder.
  if (rawInput.includes('T05-52-32') || rawInput.includes('Design Studio 2')) {
    return '';
  }
...
// Expose legacy service details renderer for feature-wrapper delegation.
(globalThis as any).renderServiceDetailsModal = renderServiceDetailsModal;
...
// Expose legacy service showcase details renderer for feature-wrapper delegation.
(globalThis as any).renderServiceShowcaseDetailsModal = renderServiceShowcaseDetailsModal;
...
const getBookingSortScore = (booking: any) => {
  ...
  const status = String(booking?.status || '').toLowerCase();
  const isNewStatus = status === 'pending' || status === 'booked';
  if (isNewStatus) {
...
const openPackageCardPayment = async (pkg: Package) => {
  ...
  triggerBookingDataSync('package-booking-created');
...
const renderPackageModal = () => {
  ...
  const featureImagePools: Record<string, string[]> = {
    ...
    bathroom: ['/category/Bathroom/bathroom1.jpg', '/category/Bathroom/bathroom2.jpg', '/category/Bathroom/bathroom3.jpg', '/category/Bathroom/bathroom4.jpg', '/category/Bathroom/bathroom5.jpg', '/category/Bathroom/bathroom6.jpg'],
    ...
    gym: ['/category/Gym/gym (1).jpg', '/category/Gym/gym (2).jpg', '/category/Gym/gym (3).jpg', '/category/Gym/gym (4).jpg', '/category/Gym/gym (5).jpg'],
    pool: ['/category/Swimming pool/swimming pool.jpg', '/category/Swimming pool/swimmingpool1 - Copy.jpg', '/category/Swimming pool/swimmingpool2 - Copy.jpg', '/category/Swimming pool/swimmingpool3 - Copy.jpg', '/category/Swimming pool/swimmingpool4 - Copy.jpg', '/category/Swimming pool/swimmingpool5 - Copy.jpg'],
    garden: ['/category/Garden/garden (1).jpg', '/category/Garden/garden (2).jpg', '/category/Garden/garden (3).jpg', '/category/Garden/garden (4).jpg', '/category/Garden/garden (5).jpg', '/category/Garden/garden (6).jpg'],
...
// Expose legacy package renderer for feature-wrapper delegation.
...
const calculatePrice = () => {
  ...
  const ContextImages = {
    ...
    bathroom: [
      ...
      '/category/Bathroom/bathroom6.jpg',
      '/category/Bathroom/bathroom7.jpg',
      '/category/Bathroom/bathroom8.jpg',
      '/category/Bathroom/bathroom9.jpg',
      '/category/Bathroom/bathroom10.jpg'
    ],
    kitchen: [
    ...
    pool: [
      ...
      '/category/Swimming pool/swimmingpool6 - Copy.jpg',
      '/category/Swimming pool/swimmingpool7 - Copy.jpg',
      '/category/Swimming pool/swimmingpool8 - Copy.jpg',
      '/category/Swimming pool/swimmingpool9 - Copy.jpg',
      '/category/Swimming pool/swimmingpool10 - Copy.jpg',
      '/category/Swimming pool/swimmingpool11 - Copy.jpg',
      '/category/Swimming pool/swimmingpool12 - Copy.jpg'
    ],
    garden: [
      ...
      '/category/Garden/garden (6).jpg',
      '/category/Garden/garden (7).jpg',
      '/category/Garden/garden (8).jpg',
      '/category/Garden/garden (9).jpg',
      '/category/Garden/garden (10).jpg',
      '/category/Garden/garden (11).jpg',
      '/category/Garden/garden.jpg'
    ],
    homeTheatre: [
  ...
  if (isFullHome) {
    ...
    // Use alias-aware filtering: match by category or alias tokens
    const normalizedCategory = String(effectiveCategory).toLowerCase().replace(/[^a-z0-9]+/g, ' ').trim();
    const selectedCategoryKey = normalizeFeatureText(normalizedCategory);
    const aliasTokens = categoryAliasTokens[selectedCategoryKey] || normalizedCategory.split(' ').filter(Boolean);
    const strictlyFiltered = (state.calculator.relatedDesigns || []).filter((item: any) => {
      const itemCategory = String(item?.category || '').toLowerCase().replace(/[^a-z0-9]+/g, ' ').trim();
      if (itemCategory === normalizedCategory) return true;
      if (aliasTokens.some(token => itemCategory.includes(token) || token.includes(itemCategory))) return true;
      return false;
    });
    if (strictlyFiltered.length > 0) {
      state.calculator.relatedDesigns = strictlyFiltered;
    }
  }

  if (recommendationHomeType === 'apartment') {
    // For apartments, ensure category-specific designs are shown when explicitly selected
    // Use alias-aware matching so categories like office interior, meeting room, gym, spa, balcony, terrace, and garden retain their related designs.
    const selectedCategory = normalizeFeatureText(effectiveCategory).toLowerCase();
    const selectedCategoryTokens = categoryAliasTokens[selectedCategory] || selectedCategory.split(' ').filter(Boolean);
  ...
  // Enforce strict limit of 4 related designs after all filtering/mapping
  ...
  saveCalculationRecord({
    ...
    userType: state.currentUser?.id ? 'registered' : 'guest',
...
(globalThis as any).renderPriceCalculatorModal = renderPriceCalculatorModal;
...
const render = () => {
  ...
  requestAnimationFrame(() => {
    ...
    try {
      ...
      console.error('renderInternal failed:', error);
      // Fallback render
...
(globalThis as any).__app_state = state;
(globalThis as any).__app_render = render;
...
const renderInternal = () => {
  ...
  if (state.activeTab === 'home') {
    initSpideyHome();
    if (!servicePackagesPrewarmed) {
      runWhenBrowserIdle(() => {
        try {
          getCustomerDisplayPackages();
          servicePackagesPrewarmed = true;
        } catch (error) {
          console.warn('Service package prewarm failed:', error);
        }
      }, 120);
    }
  }
...
const renderMain = () => {
  switch (state.activeTab) {
    case 'home':
      return renderHomePageFeature();
    case 'gallery':
      return renderGalleryFeature();
    case 'categories':
      return renderCategoriesFeature();
    case 'portfolio':
      return renderPortfolioFeature();
    case 'services':
      return renderServicesFeature();
    case 'showroom':
      return renderShowroomFeature();
    case 'contact':
      return renderContactFeature();
    case 'login':
      return renderLogin();
    case 'ai-studio':
      if (state.currentUser?.role === 'customer' || state.currentUser?.role === 'admin') return renderDesignStudioFeature();
...
const maybeNormalizeTemplateMarkup = (markup: string) => {
  // Fast path for already clean templates to reduce click-to-render latency.
  if (!markup.includes('< ') && !markup.includes('</ ') && !markup.includes('data -')) {
    return markup;
  }
  return normalizeTemplateMarkup(markup);
};
...
const renderContact = () => {
  ...
  // Expose legacy contact renderer for feature-wrapper delegation.
  (globalThis as any).renderContact = renderContact;
...
const renderAdminDashboardSection = () => {
  ...
  const uniqueCustomerIds = new Set(
    knownCustomers.length > 0
      ? knownCustomers.map((user: any) => String(user?.id || '').trim()).filter(Boolean)
      : bookings.map((booking: any) => String(booking?.userId || '').trim()).filter(Boolean)
  );
  const uniqueDesignIds = new Set(
  ...
  const adminInvoices = (state.admin as any)?.invoices || [];
  const generatedInvoices = adminInvoices.filter((i: any) => i.status === 'generated' || i.status === 'sent').length;
  ...
  return `
    <section class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-14">
      ...
      <div id="admin-generated-invoices" class="spidey-panel p-6 flex items-center gap-4 md:col-span-2 xl:col-span-1">
        ...
        <div>
          <div class="text-xs text-slate-400 uppercase tracking-wider font-bold">Sent (Generated)</div>
          <div class="text-2xl font-bold text-[color:var(--primary)]">${generatedInvoices}</div>
        </div>
      </div>
    </section>
...
const resolveBookingDesignContext = (booking: any) => {
  const bookingId = String(booking?.id || '').trim();
  if (bookingId && bookingContextCache.has(bookingId)) {
    return bookingContextCache.get(bookingId)!;
  }
  ...
  // Try to resolve image from booking, design, or fallback
  const bookingImageUrl = normalizeAssetUrl(String(
    normalizedBooking?.designPreviewImage ||
    normalizedBooking?.previewImage ||
    normalizedBooking?.imageUrl ||
    normalizedBooking?.image ||
    ''
  ).trim());
  ...
  const directNameMatch = designPool.find((design: any) => {
    ...
    if (bookingNameKey && designTitleKey && designTitleKey.includes(bookingNameKey)) return true;
    if (bookingTitleKey && designTitleKey && designTitleKey.includes(bookingTitleKey)) return true;
    return false;
  }) || null;
  ...
  const scoreDesignMatch = (design: any) => {
    ...
    if (bookingTitleKey && designTitleKey === bookingTitleKey) score += 500;
    if (bookingNameKey && designTitleKey === bookingNameKey) score += 450;
    ...
    if (bookingTitleKey && designTitleKey && designTitleKey.includes(bookingTitleKey)) score += 200;
    if (bookingNameKey && designTitleKey && designTitleKey.includes(bookingNameKey)) score += 180;
  ...
  if (bookingId) {
    bookingContextCache.set(bookingId, result);
  }
    ...
    <div class="spidey-panel p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
          ...
          <button type="button" data-action="set-booking-summary-filter" data-value="failed" class="text-left p-3 rounded-xl bg-gradient-to-br from-red-50 to-red-100/50 border ${state.admin.bookingFilter.paymentStatus === 'failed' ? 'border-red-400 ring-2 ring-red-200' : 'border-red-200/50'} hover:shadow-md transition">
            <div class="text-[10px] uppercase tracking-wider text-red-600 font-semibold">âŒ Failed</div>
      ...
      ? filteredBookings
        .map((row) => {
          ...
          const bookingStatusClass = (() => {
            const status = String(booking.status).toLowerCase();
            if (status === 'approved' || status === 'confirmed' || status === 'fulfilled' || status === 'completed') return 'bg-emerald-100 text-emerald-700';
            if (status === 'declined' || status === 'cancelled' || status === 'rejected') return 'bg-red-100 text-red-700';
            if (status === 'booked') return 'bg-purple-100 text-purple-700';
                        ...
                        <div class="p-3 rounded-xl border border-black/10 bg-white hover:shadow-md transition">
                            <div class="flex items-start justify-between gap-3 mb-2">
                                ...
                                <div class="text-right flex-shrink-0">
                                  ...
                                  <div class="text-[10px] px-2 py-0.5 rounded-full ${paymentStatusColors && paymentStatusColors[bookingPaymentStatus] ? paymentStatusColors[bookingPaymentStatus] : 'bg-slate-100 text-slate-600'} mt-1 inline-block">${bookingPaymentStatus}</div>
                                </div>
                            </div>
      ...
      : '<div class="text-sm text-slate-400 text-center py-8">ðŸ“­ No bookings found matching your filters.</div>'
        ...
        ${(() => {
          ...
          return `
            <div class="flex items-center justify-center pt-4 border-t border-black/5">
...
const renderAdminInvoicesSection = () => {
  ...
  const stats = {
    ...
    generated: invoices.filter((i: any) => i.status === 'generated' || i.status === 'sent').length,
    sent: invoices.filter((i: any) => i.status === 'generated' || i.status === 'sent').length,
...
<div class="text-[10px] uppercase tracking-wider text-purple-600 font-semibold">ðŸ“¤ Sent (Generated)</div>
          <div class="text-xl font-bold text-purple-700 mt-1">${stats.generated}</div>
          </div>
...
const renderAdminCustomerDetailsModal = () => {
  ...
  const paymentsLoading = !!(state.admin as any).customerPaymentsLoading;
  const paymentsCache: any[] | null = (state.admin as any).customerPaymentsCache ?? null;
  const localPaymentsFallback = [...(state.customer.payments || []), ...getPayments()]
    .filter((payment: any, index: number, arr: any[]) => arr.findIndex((entry: any) => String(entry?.id || '') === String(payment?.id || '')) === index)
    .filter((payment: any) => String(payment?.userId || payment?.customerId || '') === String(viewingId) || bookingIds.has(String(payment?.bookingId || '')));
  const customerPayments = (paymentsCache !== null ? paymentsCache : localPaymentsFallback)
    .slice()
  ...
  return `
    ...
    return `
          ...
          <div>
            <div class="text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2">Payment History ${paymentsLoading ? 'â³' : `(${customerPayments.length})`}</div>
            ${paymentsLoading ? `
              <div class="flex items-center gap-2 py-4 text-sm text-slate-400"><span class="animate-spin">â³</span> Loading payment history...</div>
            ` : customerPayments.length ? `
              <div class="space-y-2">
                ${customerPayments.map((payment: any) => {
    const rawStatus = String(payment?.status || 'pending').toLowerCase();
    const paymentStatus = rawStatus === 'success' || rawStatus === 'paid' || rawStatus === 'completed' ? 'paid'
    ...
    const statusClass = paymentStatus === 'paid'
      ...
      : paymentStatus === 'failed'
        ...
        : 'bg-amber-100 text-amber-700';
    const statusLabel = paymentStatus === 'paid' ? 'âœ“ Paid' : paymentStatus === 'failed' ? 'âœ— Failed' : 'â³ Pending';
    const booking = customerBookings.find((item: any) => String(item?.id || '') === String(payment?.bookingId || ''));
    const paymentTitle = escapeHtml(String(payment?.designName || booking?.designName || payment?.bookingId || 'Payment'));
    const paymentDate = payment?.paymentDateTime || payment?.createdAt;
    const paymentDateStr = paymentDate ? new Date(paymentDate).toLocaleString() : '';
    return `
                    <div class="rounded-xl border border-black/5 bg-slate-50 px-4 py-3">
                      <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0 flex-1">
                          <div class="font-semibold text-slate-800 text-sm truncate">${paymentTitle}</div>
                          <div class="text-xs text-slate-500 mt-0.5">${escapeHtml(String(payment?.method || payment?.provider || 'card').toUpperCase())}${paymentDateStr ? ` Â· ${paymentDateStr}` : ''}</div>
                          ${payment?.bookingId ? `<div class="text-[10px] text-slate-400 mt-0.5">Booking: ${escapeHtml(String(payment.bookingId))}</div>` : ''}
                        </div>
            ...
            ` : '<span class="text-sm text-slate-400">No payment records found for this customer</span>'}
          </div>
          <div>
...
let customerDisplayPackagesCache: { signature: string; data: Package[] } | null = null;
let customerDisplayPackagesByIdCache: { signature: string; data: Record<string, Package> } | null = null;

const buildCustomerDisplayPackagesSignature = (rawPackages: any[], categories: any[]): string => {
  const packageSignature = rawPackages
    .map((pkg: any) => {
      const roomCount = Array.isArray(pkg?.rooms) ? pkg.rooms.length : 0;
      return `${String(pkg?.id || '')}:${String(pkg?.updatedAt || '')}:${roomCount}:${String(pkg?.category || '')}:${String(pkg?.name || '')}:${String(pkg?.subtitle || '')}:${Number(pkg?.originalPrice || 0)}:${Number(pkg?.discountedPrice || 0)}:${Array.isArray(pkg?.features) ? pkg.features.length : 0}:${String(pkg?.image || '')}`;
    })
    .join('|');
  ...
  const categorySignature = categories
    .map((cat: any) => {
      ...
      const firstImage = String(images[0]?.url || cat?.image || cat?.thumbnail || '');
      return `${String(cat?.id || cat?.title || cat?.name || '')}:${images.length}:${firstImage}`;
    })
    .join('|');

  return `${String(state.calculator?.category || '')}::${packageSignature}::${categorySignature}`;
};

const getCustomerDisplayPackages = (): Package[] => {
  const rawPackages = getPackagesSync() || [];
  const categories = (state.customer.categories && state.customer.categories.length > 0)
    ? state.customer.categories
    : getCategories();

  const signature = buildCustomerDisplayPackagesSignature(rawPackages, categories);
  if (customerDisplayPackagesCache && customerDisplayPackagesCache.signature === signature) {
    return customerDisplayPackagesCache.data;
  }
  ...
  const CATEGORY_RULES: Array<{ key: string; title: string; aliases: string[]; match: RegExp }> = [
    ...
    { key: 'classroom', title: 'Classroom', aliases: ['Classroom'], match: /\b(classroom|class|school|education|training|learning)\b/i }
  ];
  ...
  const computedPackages = allRaw.map((rawPackage: any, packageIndex: number) => {
  ...
  customerDisplayPackagesCache = {
    signature,
    data: computedPackages
  };

  customerDisplayPackagesByIdCache = {
    signature,
    data: computedPackages.reduce((acc: Record<string, Package>, pkg: Package) => {
      acc[String(pkg.id || '')] = pkg;
      return acc;
    }, {})
  };

  return computedPackages;
};

const getCustomerDisplayPackageById = (id: string): Package | undefined => {
  const packages = getCustomerDisplayPackages();
  const signature = customerDisplayPackagesCache?.signature || '';
  if (!customerDisplayPackagesByIdCache || customerDisplayPackagesByIdCache.signature !== signature) {
    customerDisplayPackagesByIdCache = {
      signature,
      data: packages.reduce((acc: Record<string, Package>, pkg: Package) => {
        acc[String(pkg.id || '')] = pkg;
        return acc;
      }, {})
    };
  }
  return customerDisplayPackagesByIdCache.data[String(id || '')];
};
    ...
    <div class="spidey-panel overflow-hidden flex flex-col min-h-[600px]">
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ${activeAdminTab === 'settings' ? `
          <div class="space-y-10">
            <section>
              ...
              <div class="mt-3">
                <button type="button" data-action="save-calc-section" data-section="core" class="px-4 py-2 rounded-lg bg-emerald-500 text-white text-xs font-bold hover:bg-emerald-600 transition">Save Core Economics</button>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="mt-3">
                <button type="button" data-action="save-calc-section" data-section="category" class="px-4 py-2 rounded-lg bg-emerald-500 text-white text-xs font-bold hover:bg-emerald-600 transition">Save Category Multipliers</button>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="mt-3">
                <button type="button" data-action="save-calc-section" data-section="shape" class="px-4 py-2 rounded-lg bg-emerald-500 text-white text-xs font-bold hover:bg-emerald-600 transition">Save Shape Multipliers</button>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="mt-3">
                <button type="button" data-action="save-calc-section" data-section="quality" class="px-4 py-2 rounded-lg bg-emerald-500 text-white text-xs font-bold hover:bg-emerald-600 transition">Save Quality Multipliers</button>
              </div>
            </section>
        ...
        ` : `
          <div class="space-y-4">
            ${history.length > 0 ? `
              <div class="mb-4 p-4 rounded-xl bg-slate-50 border border-black/5">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  <div class="p-3 rounded-lg bg-white border border-black/5">
                    <div class="text-2xl font-black text-[color:var(--primary)]">${history.length}</div>
                    <div class="text-[10px] uppercase tracking-wider text-slate-400">Total Calculations</div>
                  </div>
                  <div class="p-3 rounded-lg bg-white border border-black/5">
                    <div class="text-2xl font-black text-emerald-600">${history.filter(h => h.userId).length}</div>
                    <div class="text-[10px] uppercase tracking-wider text-slate-400">Registered Users</div>
                  </div>
                  <div class="p-3 rounded-lg bg-white border border-black/5">
                    <div class="text-2xl font-black text-amber-600">${history.filter(h => !h.userId).length}</div>
                    <div class="text-[10px] uppercase tracking-wider text-slate-400">Guest Users</div>
                  </div>
                  <div class="p-3 rounded-lg bg-white border border-black/5">
                    <div class="text-2xl font-black text-slate-700">â‚¹${history.reduce((sum, h) => sum + (h.result || 0), 0).toLocaleString()}</div>
                      ...
                      return `
                        <tr class="hover:bg-slate-50 transition">
                          ...
                          <td class="py-4 px-2 text-slate-600">
                            ...
                            <div class="text-[10px]">Shape: ${item.shape} Â· Quality: <span class="capitalize">${item.quality}</span></div>
                            ${item.packageId ? `<div class="text-[10px] text-blue-600">Package Applied</div>` : ''}
                          </td>
                          <td class="py-4 px-2 text-right">
                            <div class="font-black text-slate-900 text-lg">â‚¹${Number(item.result || 0).toLocaleString()}</div>
...
const renderAdminPortfolioSection = () => {
  ...
  const serviceEmojis: Record<string, string> = {
    ...
    'Corridor Design': 'ðŸš¶',
    'Terrace/Garden': 'ðŸŒ³',
    'Commercial Interiors': 'ðŸ¢'
  };
  const emojiOptions = [
    'ðŸŽ¨', 'ðŸ“', 'ðŸ—ï¸', 'ðŸ“±', 'ðŸ§±', 'ðŸ’¡', 'ðŸ“', 'ðŸ›‹ï¸', 'ðŸªš', 'âœ¨',
    'ðŸ–Œï¸', 'ðŸº', 'ðŸ‘¨â€ðŸ³', 'ðŸšª', 'ðŸš¿', 'ðŸŒ¿', 'ðŸ•‰ï¸', 'ðŸ“', 'âœ¨', 'ðŸ› ï¸',
    'ðŸ›ï¸', 'ðŸ§¸', 'ðŸ’¼', 'ðŸ½ï¸', 'ðŸ“º', 'ðŸ¥£', 'ðŸ“š', 'ðŸ›Œ', 'ðŸ§º', 'ðŸš¶',
    'ðŸŒ³', 'ðŸ¢', 'ðŸŽ­', 'ðŸŽª', 'ðŸŒŸ', 'ðŸ”¥', 'ðŸ’Ž', 'ðŸŒˆ', 'ðŸ¦‹', 'ðŸŒ¸'
  ];
  return `
    <section class="spidey-panel p-6">
        <div class="flex items-center justify-between mb-6">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <div class="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
                    <button type="button" class="text-lg hover:scale-125 transition p-1" onclick="document.getElementById('emoji-picker-${isEditingService ? 'edit' : 'add'}').classList.toggle('hidden')" title="Pick emoji">ðŸ˜€</button>
                  </div>
                  <div id="emoji-picker-${isEditingService ? 'edit' : 'add'}" class="hidden absolute z-20 right-0 top-full mt-1 p-2 bg-white rounded-xl border border-black/10 shadow-lg grid grid-cols-5 gap-1 max-w-48 max-h-32 overflow-y-auto">
                    ${emojiOptions.map(emoji => `<button type="button" class="text-lg hover:scale-125 transition p-1 hover:bg-slate-100 rounded" onclick="document.querySelector('[name=\\'icon\\']').value='${emoji}';document.getElementById('emoji-picker-${isEditingService ? 'edit' : 'add'}').classList.add('hidden')" title="${emoji}">${emoji}</button>`).join('')}
                  </div>
                </div>
              </div>
                </div>
